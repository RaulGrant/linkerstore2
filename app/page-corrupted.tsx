...
import { ArrowRight, ShoppingBag, Target, Clock } from "lucide-react";
    ...
    >
      ...
      >
        <motion.div
          ...
          animate={{ scale: [1, 1.8, 1], rotate: 360, opacity: [0.3, 0.7, 0.3] }}
          transition={{ duration: 1.2, repeat: Infinity, ease: "easeInOut", type: "tween" }}
        />
      </motion.div>
        ...
        <div className="absolute inset-0 overflow-hidden">
          {[...Array(10)].map((_, index) => (
            <motion.div
              ...
              animate={{ x: [0, 60, -60, 0], y: [0, -30, 30, 0], opacity: [0.3, 0.8, 0.3], scale: [1, 1.5, 1] }}
              transition={{ duration: 2 + index * 0.1, repeat: Infinity, delay: index * 0.2, type: "tween" }}
              style={{ left: `${index * 10}%`, top: `${30 + (index % 2) * 40}%` }}
            />
          ))}
        </div>
      ...
      >
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            <motion.div className="relative inline-block mb-8" whileHover={{ scale: 1.3 }}>
              {[...Array(4)].map((_, index) => (
                <motion.div
                  key={index}
                  ...
                  style={{
                    ...
                    left: `calc(50% - ${60 + index * 20}px)`,
                    top: `calc(50% - ${60 + index * 20}px)`,
                  }}
                  animate={{ rotate: [0, 360], scale: [1, 1.2, 1], opacity: [0.2, 0.6, 0.2] }}
                  transition={{ duration: 4 + index, repeat: Infinity, ease: "linear", delay: index * 0.5, type: "tween" }}
                />
              ))}
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.2, rotate: 15, filter: "drop-shadow(0 0 50px rgba(147, 51, 234, 1))" }}
              >
                🏭
              </motion.div>
            </motion.div>
            ...
            <motion.h1
              ...
              whileHover={{ scale: 1.05, textShadow: "0 0 30px rgba(147, 51, 234, 0.8)" }}
            >
              LinkerStore
            </motion.h1>
            ...
            >
              La plataforma más avanzada para equipos industriales y de protección personal. Calidad premium,
              precios competitivos y entregas confiables.
            </motion.p>
            ...
            >
              <motion.div whileHover={{ scale: 1.08, y: -5 }} whileTap={{ scale: 0.95 }}>
                {/* CTA temporalmente deshabilitada mientras se reactiva /store */}
                {/*
                <Button
                  size="lg"
            ...
            >
              {[
                ...
                >
                  <Badge className={`bg-gradient-to-r ${badge.color} text-white px-4 py-2 text-sm font-medium shadow-lg cursor-pointer`}>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Equipos Industriales por Sector</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Productos verificados y categorizados especialmente para contratistas, electricistas, soldadores y
          ...
          >
            {[
              ...
              <motion.div
                ...
                initial={{ y: 100, opacity: 0, scale: 0.8 }}
                animate={{ y: 0, opacity: 1, scale: 1 }}
                transition={{ duration: 0.6, delay: 1.6 + index * 0.2, type: "spring", bounce: 0.4 }}
                whileHover={{ scale: 1.05, y: -10, transition: { type: "spring", bounce: 0.4 } }}
                whileTap={{ scale: 0.95 }}
              >
                {/* TODO: Rehabilitar navegación a /store cuando la sección esté lista */}
                <div className="group block">
                  ...
                  >
                    <div className="relative z-10">
                      <div
                        className={`${category.color} p-4 rounded-xl w-16 h-16 flex items-center justify-center shadow-lg mb-6`}
                      >
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            Explora nuestro catálogo completo de productos verificados en Amazon. Equipos profesionales para contratistas que
            exigen calidad.
          </motion.p>
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              {/* CTA de catálogo suspendida hasta reactivar /store */}
