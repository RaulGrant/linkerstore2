...
var AnemometerHighlight = function () { return (<div className="my-8">
    ...
    <framer_motion_1.motion.div className="bg-gradient-to-br from-slate-50 to-blue-50 p-4 sm:p-6 md:p-8 rounded-3xl shadow-xl border-2 border-blue-100" initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
      ...
      <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">
        Anemómetro Digital de Alta Precisión (0-30 m/s)
      </h3>
      ...
      <p className="text-gray-700 mb-6 text-base leading-relaxed">
        Para cumplir con la prohibición de trabajar con vientos superiores a 40 km/h, no puedes confiar en tu instinto. Este dispositivo ofrece lectura inmediata y retroiluminada, ideal para torres y andamios.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
        <div className="bg-white/80 p-3 rounded-xl border border-green-200">
          ...
          <ul className="space-y-1 text-xs text-gray-700">
            ...
            <li>• Pantalla LCD retroiluminada (trabajo nocturno)</li>
            <li>• Compacto y resistente a caídas leves</li>
          </ul>
        </div>
        <div className="bg-white/80 p-3 rounded-xl border border-slate-200">
          <div className="flex items-center justify-between h-full">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-700">$350 - $500 MXN</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-4 flex gap-3 justify-center text-sm text-blue-600">
        <a href="https://mercadolibre.com/sec/2eFk373" target="_blank" className="hover:underline font-medium">• Cinta de Barricada</a>
...
var HarnessHighlight = function () { return (<framer_motion_1.motion.div className="my-8 bg-gradient-to-br from-orange-50 to-red-50 p-4 sm:p-6 md:p-8 rounded-3xl shadow-xl border-2 border-orange-200" initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
    ...
    <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3">
      Arnés de Cuerpo Completo (3 Anillos) - Certificado
    </h3>
    ...
    <p className="text-gray-700 mb-6">
      No arriesgues la vida con equipos genéricos. Este modelo cuenta con <strong>anillo D dorsal para detención de caídas</strong> y anillos laterales para posicionamiento (manos libres), cumpliendo con lo exigido en el Punto Clave 3.
    </p>
    ...
    <div className="grid gap-3">
      ...
      <div className="grid grid-cols-2 gap-3 mt-2">
        <a href="https://mercadolibre.com/sec/18FXEdR" target="_blank" className="text-center py-2 px-4 rounded-lg bg-white border border-gray-200 text-xs text-gray-700 font-bold hover:bg-gray-50 hover:text-orange-600 transition-colors">
          + Agregar Línea con Amortiguador
        </a>
        <a href="https://mercadolibre.com/sec/1yZQSU9" target="_blank" className="text-center py-2 px-4 rounded-lg bg-white border border-gray-200 text-xs text-gray-700 font-bold hover:bg-gray-50 hover:text-orange-600 transition-colors">
          + Agregar Casco con Barboquejo
        </a>
      </div>
    </div>
  </framer_motion_1.motion.div>); };
function GuiaNOM009Article() {
    ...
    <div className="flex flex-col md:flex-row gap-6 items-center relative z-10">
      <div className="flex-1">
        ...
        <p className="text-slate-300 text-sm sm:text-base mb-6 leading-relaxed">
          El arnés detiene la caída, pero estas cintas te mantienen vivo mientras esperas. Permiten al trabajador liberar la presión de las venas femorales poniéndose de pie en el aire.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          ...
          <p className="text-slate-400 text-xs">
            Inversión mínima: <span className="text-white font-bold">$250 - $400 MXN</span>
          </p>
        </div>
      </div>
  ...
  <a href="https://mercadolibre.com/sec/1e6m8NF" target="_blank" className="group bg-white p-4 rounded-xl border border-gray-200 hover:border-green-400 transition-all hover:shadow-md flex items-center gap-4">
    ...
    <div>
      ...
      <p className="text-xs text-gray-500">Sistema 4:1 para descenso controlado.</p>
    </div>
  </a>
