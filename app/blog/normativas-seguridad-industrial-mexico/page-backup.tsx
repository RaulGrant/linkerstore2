...
import HeroNormativasSeguridad from "@/components/blog/NormativasSeguridadMexico/HeroNormativasSeguridad";
import SectionBlockNormativasSeguridad from "@/components/blog/NormativasSeguridadMexico/SectionBlockNormativasSeguridad";
import RelatedGuidesBannerNormativasSeguridad from "@/components/blog/NormativasSeguridadMexico/RelatedGuidesBannerNormativasSeguridad";
import SideBannersNormativasSeguridad from "@/components/blog/NormativasSeguridadMexico/SideBannersNormativasSeguridad";

export default function GuiaNormativasSeguridadIndustrialMexico() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const introSection = document.getElementById('marco-legal-mexicano');
      const referencesSection = document.getElementById('recursos-oficiales-y-referencias');
  ...
  // SEO and meta data
  useEffect(() => {
    document.title = 'Normativas de Seguridad Industrial México | Marco Legal NOM-STPS Completo 2025';
    
    // Update meta description
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Guía completa del marco legal mexicano de seguridad industrial. NOM-STPS vigentes, obligaciones patronales, sanciones y cumplimiento normativo actualizado 2025.');
    }
  }, []);

  // Data for all 6 sections based on legal framework analysis
  const sectionsData = [
    {
      sectionNumber: 1,
      title: "Marco Legal Mexicano",
      subtitle: "Fundamentos jurídicos de la seguridad y salud en el trabajo en México",
      content: {
        introduction: "La seguridad y salud en el trabajo en México se fundamenta en la Constitución Política, la Ley Federal del Trabajo y el Reglamento Federal de Seguridad y Salud en el Trabajo, conformando un sistema normativo integral que establece derechos, obligaciones y procedimientos para la protección de los trabajadores.",
        expertQuote: {
          text: "Todo trabajador tiene derecho a que su patrón le proporcione condiciones de trabajo que aseguren la vida, la salud y un nivel económico decoroso.",
          source: "Artículo 123 Constitucional, fracción XV"
        },
        keyPoints: [
          "Constitución Política establece el derecho fundamental a la seguridad laboral",
          "Ley Federal del Trabajo regula las relaciones laborales y condiciones de trabajo",
          "Reglamento Federal de SST detalla procedimientos específicos de cumplimiento",
          "Sistema integral de protección con enfoque preventivo y correctivo"
        ],
        technicalDetails: {
          title: "Jerarquía Normativa en Seguridad Laboral",
          items: [
            "Constitución Política de los Estados Unidos Mexicanos - Art. 123",
            "Ley Federal del Trabajo - Título IX (Arts. 512-536)",
            "Reglamento Federal de Seguridad y Salud en el Trabajo",
            "Normas Oficiales Mexicanas NOM-STPS específicas"
          ]
        },
        warningBox: {
          title: "Principio de Responsabilidad Patronal",
          content: "El patrón es responsable de proporcionar un ambiente de trabajo seguro y saludable. Esta responsabilidad es intransferible y abarca tanto la prevención como la reparación del daño.",
          type: "warning"
        },
        tips: [
          "La responsabilidad patronal es objetiva e intransferible",
          "Los trabajadores tienen derecho a capacitación gratuita en seguridad",
          "Las comisiones mixtas son obligatorias según el tamaño de la empresa",
          "El incumplimiento puede generar responsabilidad civil y penal"
        ]
      }
    },
    {
      sectionNumber: 2,
      title: "Normas NOM-STPS",
      subtitle: "Catálogo completo de Normas Oficiales Mexicanas en Seguridad y Salud en el Trabajo",
      content: {
        introduction: "Las Normas Oficiales Mexicanas de la Secretaría del Trabajo y Previsión Social (NOM-STPS) constituyen el marco técnico específico que regula aspectos particulares de la seguridad y salud ocupacional, estableciendo criterios, procedimientos y especificaciones técnicas de obligatorio cumplimiento.",
        keyPoints: [
          "41 normas NOM-STPS vigentes cubren todos los aspectos de seguridad laboral",
          "Clasificación por temas: edificios, EPP, maquinaria, sustancias químicas",
          "Actualización periódica conforme a avances técnicos y científicos",
          "Cumplimiento obligatorio con verificación por parte de la autoridad laboral"
        ],
        technicalDetails: {
          title: "Normas NOM-STPS Fundamentales",
          items: [
        ...
        warningBox: {
          ...
          content: "Las NOM-STPS se actualizan periódicamente. Es responsabilidad del patrón mantenerse informado sobre las modificaciones y aplicar las versiones vigentes.",
          type: "info"
        },
        tips: [
          "Suscríbete al Diario Oficial de la Federación para actualizaciones",
          "Mantén un registro de las normas aplicables a tu actividad",
          "Consulta el sitio oficial de STPS para verificar vigencia",
          "Establece procedimientos de revisión periódica de cumplimiento"
        ]
      }
    },
    {
      ...
      subtitle: "Responsabilidades específicas del empleador en materia de seguridad y salud laboral",
      content: {
        introduction: "Las obligaciones patronales en materia de seguridad y salud laboral constituyen un sistema integral de responsabilidades que abarcan desde la provisión de condiciones seguras hasta la capacitación continua, estableciendo un marco de prevención y protección para todos los trabajadores.",
        expertQuote: {
          text: "Los patrones tienen la obligación de proporcionar a los trabajadores los equipos de protección individual y ropa de trabajo apropiados, según la naturaleza del trabajo, sin costo alguno para los trabajadores.",
          source: "Artículo 132, fracción XVI, Ley Federal del Trabajo"
        },
        keyPoints: [
          "Proporcionar condiciones seguras y saludables de trabajo",
          "Suministrar EPP certificado sin costo para el trabajador",
          "Impartir capacitación en seguridad e higiene industrial",
          "Formar e integrar comisiones mixtas de seguridad e higiene"
        ],
        technicalDetails: {
          title: "Documentación Obligatoria del Patrón",
          items: [
            "Programa de seguridad e higiene en el trabajo",
            "Análisis de riesgos potenciales por puesto de trabajo",
            "Registros de capacitación en seguridad e higiene",
            "Bitácoras de entrega y uso de equipo de protección personal"
          ]
        },
        warningBox: {
          title: "Responsabilidad Objetiva del Patrón",
          content: "La responsabilidad patronal es objetiva, lo que significa que el patrón responde por los daños causados independientemente de su culpa o negligencia, siempre que se demuestre la relación causal con el trabajo.",
          type: "danger"
        },
        tips: [
          "Establece procedimientos documentados para todas las obligaciones",
          "Designa responsables específicos para cada área de cumplimiento",
          "Implementa sistemas de verificación y seguimiento continuos",
          "Mantén evidencia documental de todas las actividades preventivas"
        ]
      }
    },
    {
      ...
      subtitle: "Proceso de verificación gubernamental y régimen sancionador por incumplimiento",
      content: {
        introduction: "El sistema de inspección laboral mexicano opera a través de inspectores federales del trabajo facultados para verificar el cumplimiento de las disposiciones de seguridad y salud, con amplias atribuciones para imponer medidas correctivas y sanciones que van desde amonestaciones hasta clausuras definitivas.",
        keyPoints: [
          "Inspecciones programadas, por denuncia o por accidente de trabajo",
          "Facultades amplias de verificación documental y física de las instalaciones",
          "Régimen sancionador escalonado según gravedad del incumplimiento",
          "Multas de $1,543 hasta $2,106,355 pesos según tipo de infracción"
        ],
        technicalDetails: {
          title: "Clasificación de Infracciones y Sanciones",
          items: [
            "Infracciones leves: 15 a 155 UMA ($1,543.50 - $15,953.50)",
            "Infracciones graves: 156 a 770 UMA ($16,056.60 - $79,289.00)",
            "Infracciones muy graves: 771 a 20,450 UMA ($79,391.90 - $2,106,355.00)",
            "Medidas de seguridad: clausura parcial, total o definitiva"
          ]
        },
        warningBox: {
          title: "Consecuencias del Incumplimiento",
          content: "Además de las multas económicas, el incumplimiento puede generar responsabilidad civil por daños, responsabilidad penal por homicidio o lesiones culposas, y afectación grave a la reputación empresarial.",
          type: "danger"
        },
        tips: [
          "Coopera plenamente con los inspectores durante las visitas",
          "Mantén toda la documentación organizada y accesible",
          "Corrige inmediatamente las observaciones señaladas",
          "Considera la asesoría legal especializada para casos complejos"
        ]
      }
    },
    {
      sectionNumber: 5,
      title: "Cumplimiento y Procedimientos",
      subtitle: "Metodología práctica para garantizar el cumplimiento normativo integral",
      content: {
        introduction: "El cumplimiento efectivo de las normativas de seguridad industrial requiere la implementación de sistemas de gestión estructurados que integren la planificación, ejecución, verificación y mejora continua, asegurando no solo el cumplimiento legal sino la protección real de los trabajadores.",
        keyPoints: [
          "Implementación de sistemas de gestión de seguridad y salud ocupacional",
          "Establecimiento de procedimientos documentados y verificables",
          "Capacitación continua y actualización del personal responsable",
          "Auditorías internas y externas para verificación de cumplimiento"
        ],
        technicalDetails: {
          title: "Elementos de un Sistema de Gestión SST",
          items: [
            "Política de seguridad y salud ocupacional de la alta dirección",
            "Identificación de peligros y evaluación de riesgos laborales",
            "Objetivos, metas y programas de seguridad y salud",
            "Procedimientos operativos seguros para actividades críticas"
          ]
        },
        warningBox: {
          title: "Implementación Gradual y Sistemática",
          content: "La implementación de un sistema de gestión debe ser gradual y sistemática, priorizando los riesgos de mayor impacto y asegurando la participación activa de todos los niveles organizacionales.",
          type: "info"
        },
        tips: [
          "Inicia con un diagnóstico completo de la situación actual",
          "Establece prioridades basadas en la evaluación de riesgos",
          "Involucra activamente a supervisores y trabajadores en el proceso",
          "Documenta todos los procedimientos y mantén registros actualizados"
        ]
      }
    },
    {
      sectionNumber: 6,
      title: "Recursos Oficiales y Referencias",
      subtitle: "Fuentes oficiales, organismos competentes y recursos para profundizar conocimientos",
      content: {
        introduction: "Esta sección proporciona un directorio completo de recursos oficiales, organismos gubernamentales, documentos normativos y fuentes de información especializada para mantenerse actualizado sobre el marco legal de seguridad industrial en México.",
        keyPoints: [
          "Secretaría del Trabajo y Previsión Social como autoridad rectora",
          "Instituto Mexicano del Seguro Social para atención médica ocupacional",
          "Diario Oficial de la Federación para publicaciones normativas",
          "Organismos certificadores y consultores especializados"
        ],
        technicalDetails: {
          title: "Organismos Oficiales Competentes",
          items: [
            "STPS: Emisión y vigilancia de NOM-STPS",
            "IMSS: Atención médica y prevención de riesgos de trabajo",
            "INFONAVIT: Programas de seguridad en construcción",
            "COFEPRIS: Regulación de sustancias químicas peligrosas"
          ]
        },
        tips: [
          "Mantén suscripción al Diario Oficial de la Federación",
          "Participa en cursos y conferencias especializadas",
          "Establece contacto con organismos certificadores reconocidos",
          "Forma una biblioteca técnica actualizada con normativas vigentes"
        ]
      }
    }
  ];
  ...
  return (
    <BlogLayout>
      {/* Side Banners */}
      <SideBannersNormativasSeguridad show={showSideBanners} />
      
      {/* Hero Section */}
      <HeroNormativasSeguridad showCTAs={showHeroCTAs} />
      
      {/* Technical Sections - No TopProducts section as requested */}
      {sectionsData.map((section, index) => (
        <SectionBlockNormativasSeguridad
          key={section.sectionNumber}
          sectionNumber={section.sectionNumber}
          title={section.title}
          subtitle={section.subtitle}
          content={section.content}
          showCTA={index === 1 || index === 3 || index === 4} // Show CTA after sections 2, 4, and 5
        />
      ))}
      
      {/* Related Guides and Resources Banner */}
      <RelatedGuidesBannerNormativasSeguridad />
    </BlogLayout>
  );
}
    <BlogLayout>
