...
export default function HeroSection() {
  const openWhatsApp = (message: string) => window.open(`https://wa.me/522413287889?text=${encodeURIComponent(message)}`, '_blank');
  const stats = [
    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          {/* Main Title */}
          <img src="/images/brands/cedetep-logo.png" alt="Logo CEDETEP" className="mx-auto mb-6 h-40 w-40 object-contain drop-shadow-2xl" />
          <motion.h1
